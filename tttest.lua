...
local MAIN_EVENT = game.ReplicatedStorage.MainEvent
local MAIN_FUNCTION = game.ReplicatedStorage.MainFunction
...
-- Animation left/right scrolling
local MOVE = 0.145
...
-- New animation button management
